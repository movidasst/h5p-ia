...
const sentinel = 'H5PIA_PREVIEW_V130';
if (s.includes(sentinel)) {
  console.log('Preview patch already present');
  process.exit(0);
}
const marker = 'function bind() {';
if (!s.includes(marker)) throw new Error('bind marker not found');
...
console.log('Preview patch inserted');
